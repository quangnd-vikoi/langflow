        ...
        .sort((a, b) => {
          ...
          const itemB = dataFilter[item.name][b];
				...
				.map((SBItemName) => {
					...
					return (
						<ShadTooltip content={currentItem.display_name} side="right" key={SBItemName}>
...
const UniqueInputsDraggableComponent = ({ item, currentItem, SBItemName, onDragStart, nodeColors }) => {
