...
import { DATASTAX_DOCS_URL, DISCORD_URL, DOCS_URL, GITHUB_URL, TWITTER_URL } from "@/constants/constants";
					...
					<div>
						...
						{isAdmin && !autoLogin && (
							<div>
								...
								>
									<span data-testid="menu_admin_page_button" id="menu_admin_page_button">
										Admin Page
									</span>
								</HeaderMenuItemButton>
							</div>
